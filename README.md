...
* [`src/clj/uploader/`](src/clj/uploader/): Backend and middleware source files (Clojure,
[Compojure](https://github.com/weavejester/compojure))
* [`src/cljs/uploader/`](src/cljs/uploader/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/uploader/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `uploader` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/uploader/config.cljs) defaults to `true` in
...
```clj
(ns uploader.example
  (:require [uploader.config :as config])
...
```sh
port=2000 java -jar target/uploader.jar
```
